...
function Deck() {
    ...
    const {events, setEvents, removeEvent, fetchEvents} = useEventStore(state => state)
    ...
    return (
        <>
            {filteredProps.length === 0 && <div
                className={'mt-20 flex text-center justify-center items-center font-ppmori font-semibold text-[#131313] text-sm'}>
                No more suggestions to show.<br/>Please come back later!
            </div>}
...
export default function Recommendations() {
    ...
    return (
        <>
            <div className={`flex fill flex-col items-center justify-center`}>
                <>
                    <Deck/>
                </>
            </div>
